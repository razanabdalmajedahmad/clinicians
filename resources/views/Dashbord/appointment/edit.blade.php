        ...
        <div class="pagetitle col">
            ...
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a>update Appointment</a></li>
                </ol>
            </nav>
        </div>
        <div>
                        ...
                        <form id="form">
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-8 col-md-12">
                                    ...
                                    <input type="text" class="form-control" name="id" hidden value="{{$appointment->id}}">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-8 col-md-12">
                                    <textarea name="description" class="form-control" id="" cols="30" rows="5">{{$appointment->description}}</textarea>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6 col-sm-12">
                                    ...
                                    <div class="col-sm-8 col-md-12">
                                        <input type="text" class="form-control" name="date" id="date" value="{{$appointment->date}}">
                                ...
                                <div class="col-md-6 col-sm-12">
                                    ...
                                    <div class="col-sm-8 col-md-12">
                                        <input type="text" class="form-control" name="time" id="time" value="{{$appointment->time}}">
    ...
    <script>
        $('#form').on('submit', function(e) {
            ...
            $.ajax({
                ...
                url: "{{ route('appointment_update_post') }}",
                data: formData,
                beforeSend: function() {
